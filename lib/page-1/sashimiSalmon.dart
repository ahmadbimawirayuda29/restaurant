...
class SashimiSalmon extends StatefulWidget {
  @override
  State<SashimiSalmon> createState() => _SashimiSalmon();
}

class _SashimiSalmon extends State<SashimiSalmon> {
  int _count = 0;
  int harga = 35000;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'Sashimi salmon adalah potongan segar ikan salmon yang dipotong tipis dan disajikan segar tanpa dimasak, menawarkan cita rasa lezat serta kualitas tekstur yang halus dan nikmat. Cocok untuk para pencinta hidangan ikan mentah.',
                                      style: SafeGoogleFont(
                                        'Rubik',
                                        fontSize: 12 * ffem,
                                        fontWeight: FontWeight.w400,
