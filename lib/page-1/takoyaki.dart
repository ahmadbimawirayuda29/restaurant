...
class Takoyaki extends StatefulWidget {
  @override
  State<Takoyaki> createState() => _Takoyaki();
}

class _Takoyaki extends State<Takoyaki> {
  int _count = 0;
  int harga = 35000;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'Takoyaki adalah makanan Jepang yang populer, dengan bola-bola kecil yang mengandung gurita dan berbagai bahan lezat, sering dihidangkan dengan saus khasnya.',
                                      style: SafeGoogleFont(
                                        'Rubik',
                                        fontSize: 12 * ffem,
                                        fontWeight: FontWeight.w400,
