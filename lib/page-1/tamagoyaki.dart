...
class Tamagoyaki extends StatefulWidget {
  @override
  State<Tamagoyaki> createState() => _Tamagoyaki();
}

class _Tamagoyaki extends State<Tamagoyaki> {
  int _count = 0;
  int harga = 35000;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'Tamagoyaki adalah hidangan Jepang yang terdiri dari lapisan-lapisan telur yang digulung dan dimasak dengan rasa lezat dan lembut. Cocok sebagai hidangan sarapan atau camilan.',
                                      style: SafeGoogleFont(
                                        'Rubik',
                                        fontSize: 12 * ffem,
                                        fontWeight: FontWeight.w400,
