...
class Chawanmushi extends StatefulWidget {
  @override
  State<Chawanmushi> createState() => _Chawanmushi();
}

class _Chawanmushi extends State<Chawanmushi> {
  int _count = 0;
  int harga = 35000;
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      'Nikmati kelezatan Chawanmushi, hidangan sup Jepang dengan telur kocok, kaldu dashi, daging ayam, udang, jamur, dan sayuran. Hidangan sempurna untuk menciptakan pengalaman kuliner Jepang yang autentik.',
                                      style: SafeGoogleFont(
                                        'Rubik',
                                        fontSize: 12 * ffem,
                                        fontWeight: FontWeight.w400,
